...
1) E-Classrooms with Class Scheduler and Online Sessions.

2) Mobile Application to submit Assignments & Notes w.r.t Courses.

3) AI based Case Study Designer Application for Students.

4) AI based Pen which will digitalize notes (For teachers & Students).

5) Mobile Application to Train Teachers for Hybrid Classrooms.

6) AI Based Query Resolver.

7) Smart Game to learn how to draw Alphabets for early classes.

8) Training centers to train students for Hybrid Study.

9) Automated Attendance System.

10) AI based Distance Measurement System.

11) Smart Game to learn how to draw Numbers for early classes.

12) Automated Lecture Recording System.

13) Setting up factories to produce cheap Mobile Phones.

14) Easily accessible internet through satellites where cable internet cannot be provided.

15) Setting up solar panels for electricity supply.

16) Interacting with students through Facebook groups. Teachers can share videos and appropriate helping material.

17) Whatsapp groups can decrease the communication gap and make it easier for students to make queries and get them resolved.

18) Zoom sessions can be used for conducting online sessions.

19) Digital notebooks where student can write assuming screen as a book and not have to spend money on notebooks.

20) Digital library where all the course books are shared which students can download in form of pdfs.
